...
DATA_EMIS_DIFF_20221023 = {
    'GAMMA_A':{
        'AAXX': {3: 0.00 , 9: 0.00 , 27: np.nan},   'ACET': {3: 0.00 , 9: 0.00 , 27: np.nan},
        'ALD2': {3: 0.00 , 9: 0.00 , 27: np.nan},   'APIN': {3: 1.24 , 9: 1.53 , 27: np.nan},
        'BCAR': {3:-1.24 , 9:-1.53 , 27: np.nan},   'BPIN': {3: 1.24 , 9: 1.53 , 27: np.nan},
        'C2H4': {3: 0.00 , 9: 0.00 , 27: np.nan},   'CARE': {3: 1.24 , 9: 1.53 , 27: np.nan},
        'CH2O': {3: 0.00 , 9: 0.00 , 27: np.nan},   'EOH' : {3: 0.00 , 9: 0.00 , 27: np.nan},
        'FARN': {3:-1.24 , 9:-1.53 , 27: np.nan},   'FAXX': {3: 0.00 , 9: 0.00 , 27: np.nan},
        'HCNX': {3: 0.00 , 9: 0.00 , 27: np.nan},   'ISOP': {3:-2.49 , 9:-3.05 , 27: np.nan},
        'LIMO': {3: 1.24 , 9: 1.53 , 27: np.nan},   'MBOX': {3:-2.49 , 9:-3.05 , 27: np.nan},
        'MOH' : {3: 4.98 , 9: 6.11 , 27: np.nan},   'MYRC': {3: 1.24 , 9: 1.53 , 27: np.nan},
        'OCIM': {3: 1.24 , 9: 1.53 , 27: np.nan},   'OMON': {3: 1.24 , 9: 1.53 , 27: np.nan},
        'OSQT': {3:-1.24 , 9:-1.53 , 27: np.nan},   'PRPE': {3: 0.00 , 9: 0.00 , 27: np.nan},
        'SABI': {3: 1.24 , 9: 1.53 , 27: np.nan},   'TOLU': {3: 0.00 , 9: 0.00 , 27: np.nan},
    },
    'GAMMA_LAI':{
